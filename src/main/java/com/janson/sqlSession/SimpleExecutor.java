...
import com.janson.config.BoundSql;
import com.janson.pojo.Configuration;
import com.janson.pojo.MappedStatement;
import com.janson.utils.GenericTokenParser;
import com.janson.utils.ParameterMapping;
import com.janson.utils.ParameterMappingTokenHandler;
...
public class SimpleExecutor implements Executor {
    ...
    public <E> List<E> query(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        // 转换sql语句 select * from user where id = ?  and username = ? 转换过程中，需要对#{}里面的值进行解析存储
